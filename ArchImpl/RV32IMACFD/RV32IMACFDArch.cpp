...
void RV32IMACFDArch::resetCPU(ETISS_CPU * cpu,etiss::uint64 * startpointer)
{
	...
	rv32imacfdcpu->CSR_MVENDORID = 0;
	rv32imacfdcpu->CSR_MARCHID = 0;
	rv32imacfdcpu->CSR_MIMPID = 0;
	rv32imacfdcpu->CSR_MHARTID = 0;
	rv32imacfdcpu->CSR_MCONFIGPTR = 0;
	rv32imacfdcpu->CSR_MSTATUS = 0;
	rv32imacfdcpu->CSR_MISA = 0;
	rv32imacfdcpu->CSR_MEDELEG = 0;
	rv32imacfdcpu->CSR_MIDELEG = 0;
	rv32imacfdcpu->CSR_MIE = 0;
	rv32imacfdcpu->CSR_MTVEC = 0;
	rv32imacfdcpu->CSR_MCOUNTEREN = 0;
	rv32imacfdcpu->CSR_MSTATUSH = 0;
	rv32imacfdcpu->CSR_MSCRATCH = 0;
	rv32imacfdcpu->CSR_MEPC = 0;
	rv32imacfdcpu->CSR_MCAUSE = 0;
	rv32imacfdcpu->CSR_MTVAL = 0;
	rv32imacfdcpu->CSR_MIP = 0;
	rv32imacfdcpu->CSR_MTINST = 0;
	rv32imacfdcpu->CSR_MTVAL2 = 0;
	rv32imacfdcpu->CSR_MENVCFG = 0;
	rv32imacfdcpu->CSR_MENVCFGH = 0;
	rv32imacfdcpu->CSR_MSECCFG = 0;
	rv32imacfdcpu->CSR_MSECCFGH = 0;
	for (int i = 0; i < 32; ++i) {
		rv32imacfdcpu->F[i] = 0;
	}
	rv32imacfdcpu->CSR_CPM = 0;
	rv32imacfdcpu->RES_ADDR = 0;
 	...
 	rv32imacfdcpu->CSR[3857] = &rv32imacfdcpu->CSR_MVENDORID;
 	rv32imacfdcpu->CSR[3858] = &rv32imacfdcpu->CSR_MARCHID;
 	rv32imacfdcpu->CSR[3859] = &rv32imacfdcpu->CSR_MIMPID;
 	rv32imacfdcpu->CSR[3860] = &rv32imacfdcpu->CSR_MHARTID;
 	rv32imacfdcpu->CSR[3861] = &rv32imacfdcpu->CSR_MCONFIGPTR;
 	rv32imacfdcpu->CSR[768] = &rv32imacfdcpu->CSR_MSTATUS;
 	rv32imacfdcpu->CSR[769] = &rv32imacfdcpu->CSR_MISA;
 	rv32imacfdcpu->CSR[770] = &rv32imacfdcpu->CSR_MEDELEG;
 	rv32imacfdcpu->CSR[771] = &rv32imacfdcpu->CSR_MIDELEG;
 	rv32imacfdcpu->CSR[772] = &rv32imacfdcpu->CSR_MIE;
 	rv32imacfdcpu->CSR[773] = &rv32imacfdcpu->CSR_MTVEC;
 	rv32imacfdcpu->CSR[774] = &rv32imacfdcpu->CSR_MCOUNTEREN;
 	rv32imacfdcpu->CSR[784] = &rv32imacfdcpu->CSR_MSTATUSH;
 	rv32imacfdcpu->CSR[832] = &rv32imacfdcpu->CSR_MSCRATCH;
 	rv32imacfdcpu->CSR[833] = &rv32imacfdcpu->CSR_MEPC;
 	rv32imacfdcpu->CSR[834] = &rv32imacfdcpu->CSR_MCAUSE;
 	rv32imacfdcpu->CSR[835] = &rv32imacfdcpu->CSR_MTVAL;
 	rv32imacfdcpu->CSR[836] = &rv32imacfdcpu->CSR_MIP;
 	rv32imacfdcpu->CSR[842] = &rv32imacfdcpu->CSR_MTINST;
 	rv32imacfdcpu->CSR[843] = &rv32imacfdcpu->CSR_MTVAL2;
 	rv32imacfdcpu->CSR[778] = &rv32imacfdcpu->CSR_MENVCFG;
 	rv32imacfdcpu->CSR[794] = &rv32imacfdcpu->CSR_MENVCFGH;
 	rv32imacfdcpu->CSR[1863] = &rv32imacfdcpu->CSR_MSECCFG;
 	rv32imacfdcpu->CSR[1879] = &rv32imacfdcpu->CSR_MSECCFGH;
